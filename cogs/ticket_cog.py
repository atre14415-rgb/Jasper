...
# ================= الإعدادات الأساسية =================
MY_GUILD = discord.Object(id=1522761545484865728) 
ADMIN_ROLE_ID = 1522808463426719814  # ⚠️ آيدي رتبة الإدارة (الدعم الفني)
LOG_CHANNEL_ID = 1522799818114863244 # ⚠️ آيدي روم السجلات (اللوق) اللي بتروح له التذاكر بعد الحذف
CATEGORY_ID = 1522799794660311151    # ⚠️ آيدي الكاتيجوري (القسم) اللي بتنفتح داخله التذاكر
# ======================================================
